...
import { completeTeamOnboarding } from "@/lib/team-onboarding";

export const dynamic = "force-dynamic";

export async function POST(_req: Request, { params }: { params: { name: string; id: string } }) {
  try {
    ...
    const ok = await completeTeamOnboarding(adminPhone, id);
